    ...
    , ui(new Ui::lineditor)
{
   ...
   // ui->textEdit->setLineWidth(100);
    ...
    newFormat->setLineHeight(lineSpacing, QTextBlockFormat::SingleHeight);
...
void lineditor::on_actionNew_triggered()
{
    ...
    statusBar()->showMessage("New file has been created", 3000);
}
...
void lineditor::on_actionOpen_triggered()
{
    ...
    // Close the file
    file.close();
    statusBar()->showMessage(QString(currentFile) +" file has been opened!", 3000);
}
...
void lineditor::on_actionSave_As_triggered()
{
    ...
    // Close the file
    file.close();
    statusBar()->showMessage(QString(fileName) +" has been saved", 3000);
}
...
void lineditor::on_actionSave_triggered()
{
    ...
    out << text;
    file.close();
    statusBar()->showMessage(QString(currentFile)+" has been saved", 3000);
}
...
void lineditor::on_actionDate_triggered()
{
    ...
    // ui->textEdit->setText(date.getDate(year, month, day);
    ui->textEdit->setText(currentDate.toString());
    ui->textEdit->setLineWidth(150);
    //ui->textEdit->setText(QString());
...
void lineditor::on_actionStrike_Through_triggered()
{
    QFont f;
    f.setStrikeOut(true);
...
void lineditor::on_actionZoom_In_triggered()
{
    ui->textEdit->zoomIn();
}


void lineditor::on_actionZoom_Out_triggered()
{
